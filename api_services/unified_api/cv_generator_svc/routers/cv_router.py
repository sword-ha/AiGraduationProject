...
from cv_generator_svc.schemas.cv_schema import CVGenerateRequest, CVGenerateResponse
from cv_generator_svc.services.cv_service import CVGeneratorService, OUTPUT_DIR
...
async def generate_cv(request: CVGenerateRequest):
    """
    Accepts structured CV data and returns ATS-optimized CV text,
    score, breakdown, suggestions, and a PDF download URL.
    """
