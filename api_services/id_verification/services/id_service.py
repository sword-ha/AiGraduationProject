...
from schemas.id_schema import ExtractedIDData, IDVerificationResponse

logger = logging.getLogger(__name__)

# Allow importing from the original OCR project
_OCR_DIR = os.getenv(
    "OCR_PROJECT_DIR",
...
class IDVerificationService:
    ...
    async def verify(self, image_bytes: bytes) -> IDVerificationResponse:
        ...
        try:
            ...
            os.chdir(os.path.abspath(_OCR_DIR))  # models use relative paths
